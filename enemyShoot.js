AFRAME.registerComponent("enemy-bullets", {
    ...
    shootEnemyBullet: function () {
        ...
        for (var i = 0; i < els.length; i++) {
            ...
            //Get text attribute
            var countLifeElement = document.querySelector("#countLife")
            var playerLife = parseInt(countLifeElement.getAttribute("text").value)
            ...
            enemyBullet.addEventListener("collide", function (e) {
                if (e.detail.body.el.id === "weapon") {
                    ...
                    if (playerLife>0){
                        playerLife-=1
                        countLifeElement.setAttribute("text",{value:playerLife})
                    }
                    if(playerLife<=0){
